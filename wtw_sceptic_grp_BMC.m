%runs group model comparison on SCEPTIC log model evidence data from
%wtw_analysis
...
%%
%Set path to
f_name = 'all_outF_08-May-2018.mat'; %Set full path to posterior log evidences (We use the variable L)
...
file_path = sprintf('~/code/willingnessToWait/');
