...
try
    ...
    instrucBlock_bpd(params,rects,display,blockMins,pointConversion,nBks);
    ...
    for bkIdx = 1:nBks
        ...
        [display,trialData,datarow] = showTrials_bpd(params,rects,display,trialData,datarow);
